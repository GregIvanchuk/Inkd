    ...
    return (
        ...
        <div className={styles.ourServicesContainer}>
            ...
            <h2 className={styles.mainText}>
                {/* {s1text} */}
                Welcome to our tattoo studio! We specialize in creating unique and personalized tattoos that reflect your individual style and story. Our talented artists are dedicated to providing you with high-quality artwork in a clean and professional environment. Whether youre looking for bold and vibrant designs or intricate and delicate patterns, were here to bring your vision to life. Explore our gallery for inspiration or book a consultation to discuss your ideas with our team. Let us help you make your tattoo dreams a reality!
            </h2>
